...
public class TeacherLoginPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        teacherLogo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(teacherLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(101, 101, 101))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(12, 12, 12)
                .addComponent(teacherLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void init() {
        teacherLogo.setIcon(new FlatSVGIcon("lk/kns/school/image/teacher.svg", 105, 105));
        exitBtn.setIcon(new FlatSVGIcon("lk/kns/school/image/close.svg", 15, 15));

        emailInput.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "✉️ please enter your teacher email");
        passwordInput.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "🔒 please enter your teacher password");
    }
        ...
        if (email.isEmpty()) {
            ...
            try {
                ResultSet rs = MySQL.execute("SELECT * FROM `user` INNER JOIN `role` ON `user`.`role_id` = `role`.`role_id` "
                        + " INNER JOIN `teacher` ON `user`.`user_id` = `teacher`.`teacher.id` WHERE `teacher`.`email` = '" + email + "'"
                        + " AND `teacher`.`password` = '" + password + "' AND `role`.`role_id` = '2'");
