...
public class ProfileSettingsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Teacher Email Address :");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(teacherImage, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(50, 50, 50)
                .addComponent(teacherImage, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void loadTeacherData() {
        try {
            ResultSet rs = MySQL.execute("SELECT t.f_name, t.l_name, u.email FROM `teacher` t "
    ...
    private void setProfileImage(String imagePath) {
        ...
        teacherImage.setIcon(new ImageIcon(img));
    }
    ...
    private void profileBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_profileBtnActionPerformed
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                String projectDir = new File("").getAbsolutePath();
                File imageFolder = new File(projectDir, "teacher_image");
                ...
                String relativePath = "teacher_image/" + fileName;
    ...
    private void passwordBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordBtnActionPerformed
        ...
        try {
            // Pull specifically from the logged-in user
