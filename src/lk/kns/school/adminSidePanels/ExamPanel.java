...
public class ExamPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        chooseYear = new com.toedter.calendar.JDateChooser();
        ...
        resultTable.setPreferredSize(new java.awt.Dimension(200, 50));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(25, 25, 25)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(chooseYear, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(chooseYear, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
                    .addComponent(searchBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(18, 18, 18)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        Date yearDate = chooseYear.getDate();

        if (studentQuery.isEmpty() || selectedCls.equals("select a class") || selectedTermName.equals("select a term") || yearDate == null) {
            JOptionPane.showMessageDialog(this, "Please fill in all search fields.", "Validation Error", JOptionPane.WARNING_MESSAGE);
            return;
        }

        String examYear = new SimpleDateFormat("yyyy").format(yearDate);
        ...
        try {
            ...
            if (subjectCount > 0) {
                examTermLabel.setText(selectedTermName.toUpperCase() + " EXAMINATION - " + examYear);
    ...
    private com.toedter.calendar.JDateChooser chooseYear;
